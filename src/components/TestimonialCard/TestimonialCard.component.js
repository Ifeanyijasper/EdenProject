    ...
    return (
        <div class="relative h-48 md:flex bg-gray-100 rounded-lg p-8 md:p-0 md:px-4 w-full md:w-120">
            {testimony.img ?
                ...
                <h2 className={`w-32 h-32 md:w-48 md:h-auto text-gray-500 md:rounded-none rounded-full mx-auto text-7xl flex items-center justify-center tracking-wider`}>{extractInitials(testimony.client_name)}</h2>
            }
